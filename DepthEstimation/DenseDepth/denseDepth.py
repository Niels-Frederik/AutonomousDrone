...
parser.add_argument('--input', default='DepthEstimation/DenseDepth/examples/*.png', type=str, help='Input filename or folder.')
...
def processImage(image):
    ...
    #viz = display_images(output.copy(), image.copy())
    #plt.imshow(viz)
    #plt.show()
    return output
